object Versions {
    ...
    //butterknife，后续要将其移除，改用DataBinding
    ...
    //fragmentation
    const val fragmentationVersion = "1.3.6"
...
object Deps {
    ...
    const val roomRxJavaVersion = "androidx.room:room-rxjava2:${Versions.roomVersion}"
    ...
    const val rxBindingVersion = "com.jakewharton.rxbinding2:rxbinding:${Versions.rxbindingVersion}"
    const val butterKnifeVersion = "com.jakewharton:butterknife:${Versions.butterKnifeVersion}"
    const val butterKnifeCompilerVersion = "com.jakewharton:butterknife-compiler:${Versions.butterKnifeVersion}"
    ...
    const val aRouterVersion = "com.alibaba:arouter-api:${Versions.aRouterVersion}"
    const val aRouterCompilerVersion = "com.alibaba:arouter-compiler:${Versions.aRouterCompilerVersion}"
    ...
    const val fragmentationVersion = "me.yokeyword:fragmentation:${Versions.fragmentationVersion}"
